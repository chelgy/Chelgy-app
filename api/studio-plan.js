...
export default async function handler(req, res) {
  ...
  try {
    ...
    const style = ["vlog","tutorial","cinematic","process","fashion","showcase","entrepreneur","realestate"].includes(body.style) ? body.style : "talkinghead";
    ...
    const realestateRules =
        ...
        "\n" +
        "THE RULES:\n" +
        "- SILENCE IS NOT DEAD AIR HERE. A silent stretch showing the property is a montage block and is the most valuable footage in the video. Only cut silence where the picture is also static or nothing is being shown.\n" +
    ...
    const mergeGap = style === "fashion" ? 0.12 : style === "vlog" ? 4.0 : style === "realestate" ? 3.0 : style === "process" ? 1.5 : style === "tutorial" ? 1.0 : style === "entrepreneur" ? 0.8 : style === "cinematic" ? 0.4 : 0.3; // vlogs bridge visual moments; tutorials breathe; cinematic and talking-head cut tight
